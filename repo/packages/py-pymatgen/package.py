...
class PyPymatgen(PythonPackage):
    ...
    variant("plotting", default=False, description="Enable plotting support")
    ...
    depends_on("py-matplotlib@1.5:", when="+plotting", type=("build", "run"))
    depends_on("py-palettable@3.1.1:", when="@2021.1.1: +plotting", type=("build", "run"))
    depends_on("py-palettable@2.1.1:", when="+plotting", type=("build", "run"))
    depends_on("py-sympy", when="@2021.1.1:", type=("build", "run"))
    depends_on("py-pandas", when="@2021.1.1:", type=("build", "run"))
    depends_on("py-plotly@4.5.0:", when="@2021.1.1: +plotting", type=("build", "run"))
